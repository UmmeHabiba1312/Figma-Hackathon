    ...
    <main className='max-w-screen-2xl overflow-x-hidden mx-auto mt-[60px] mb-[80px] px-4 sm:px-6 lg:px-8'>
        ...
        <div className="group overflow-hidden rounded-[6px]  bg-white hover:shadow-xl transition-all duration-300">
          <div className="relative w-full  h-[auto] sm:h-[250px] flex justify-center items-center">
            ...
            <Image
              className="w-full sm:h-[250px] h-[400px] object-cover rounded-[6px]"
              height={250}
              width={250}
              src="/product1.png"
              alt="product1"
        ...
        {/* Product 3 */}
        <div className="group overflow-hidden rounded-[6px]  bg-white hover:shadow-xl transition-all duration-300">
          <div className="relative w-full sm:h-[250px] h-auto flex justify-center items-center">
            <Image
              className="w-full sm:h-[250px] h-[400px] object-cover rounded-[6px]"
              height={250}
              width={250}
      ...
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-[25px] mt-[80px] px-4 sm:px-4 lg:px-8">
        ...
        <div className="group overflow-hidden rounded-[6px]  bg-white hover:shadow-xl transition-all duration-300">
          <div className="relative w-full h-auto sm:h-[250px] flex justify-center items-center">
            <Image
              className="w-full h-[400px] sm:h-[250px] object-cover rounded-[6px]"
              height={250}
              width={250}
              src="/cat3.png"
              alt="product3"
