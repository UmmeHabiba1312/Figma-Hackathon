...
<Button variant="outline" className='bg-[#DB4444] h-[60px]   w-[188px] mt-10 flex justify-center items-center text-white font-bold hover:text-white hover:bg-[#d34c4c]'>Back to home page</Button>   
</Link>
    </main>
  )
}
