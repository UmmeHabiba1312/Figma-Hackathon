  ...
  const products = [
    {
      ...
      quantity: 1,
      price: 99,
      image: "/product1.png", // Path for the first product image
    },
    {
      id: 2,
      name: "Library Stool Chair",
      ...
      quantity: 1,
      price: 99,
      image: "/product2.png", // Path for the second product image
    },
  ];
  return (
    ...
    {[1, 2].map((item, index) => (
      ...
      >
        ...
        <div className="w-full md:w-1/4 text-right">
          <p className="text-sm font-medium text-gray-700">MRP: $99</p>
